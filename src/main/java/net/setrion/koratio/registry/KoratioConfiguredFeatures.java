...
public class KoratioConfiguredFeatures {
	...
	public static final ResourceKey<ConfiguredFeature<?, ?>> CANDY = registerKey("candy");
	public static final ResourceKey<ConfiguredFeature<?, ?>> CHOCOLATE_OAK = registerKey("chocolate_oak");
	...
	public static final ResourceKey<ConfiguredFeature<?, ?>> HUGE_LOLLIPOP = registerKey("huge_lollipop");
	...
	public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
		...
		context.register(CANDY, new ConfiguredFeature<>(Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(KoratioBlocks.CANDY_LOG.get().defaultBlockState()), new StraightTrunkPlacer(8, 3, 0), BlockStateProvider.simple(KoratioBlocks.PINK_COTTON_CANDY_LEAVES.get().defaultBlockState()), new CandyFoliagePlacer(ConstantInt.of(4), ConstantInt.of(0)), new ThreeLayersFeatureSize(1, 2, 3, 1, 2, OptionalInt.empty())).ignoreVines().build()));
		context.register(CHOCOLATE_OAK, new ConfiguredFeature<>(Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(KoratioBlocks.CHOCOLATE_OAK_LOG.get().defaultBlockState()), new StraightTrunkPlacer(8, 3, 0), BlockStateProvider.simple(KoratioBlocks.CHOCOLATE_OAK_LEAVES.get().defaultBlockState()), new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1)).ignoreVines().build()));
		...
		context.register(HUGE_LOLLIPOP, new ConfiguredFeature<>(KoratioFeatures.HUGE_LOLLIPOP.get(), new NoneFeatureConfiguration()));
		...
		context.register(FLOWER_CANDY_CANE_VALLEY, new ConfiguredFeature<>(Feature.FLOWER, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(KoratioBlocks.COOKIE_FLOWER.get().defaultBlockState(), 3).add(KoratioBlocks.WHITE_SUGARGLASS_FLOWER.get().defaultBlockState(), 1).add(KoratioBlocks.LIGHT_GRAY_SUGARGLASS_FLOWER.get().defaultBlockState(), 1).add(KoratioBlocks.GRAY_SUGARGLASS_FLOWER.get().defaultBlockState(), 1).add(KoratioBlocks.BLACK_SUGARGLASS_FLOWER.get().defaultBlockState(), 1).add(KoratioBlocks.BROWN_SUGARGLASS_FLOWER.get().defaultBlockState(), 1).add(KoratioBlocks.RED_SUGARGLASS_FLOWER.get().defaultBlockState(), 1).add(KoratioBlocks.ORANGE_SUGARGLASS_FLOWER.get().defaultBlockState(), 1).add(KoratioBlocks.YELLOW_SUGARGLASS_FLOWER.get().defaultBlockState(), 1).add(KoratioBlocks.LIME_SUGARGLASS_FLOWER.get().defaultBlockState(), 1).add(KoratioBlocks.GREEN_SUGARGLASS_FLOWER.get().defaultBlockState(), 1).add(KoratioBlocks.CYAN_SUGARGLASS_FLOWER.get().defaultBlockState(), 1).add(KoratioBlocks.LIGHT_BLUE_SUGARGLASS_FLOWER.get().defaultBlockState(), 1).add(KoratioBlocks.BLUE_SUGARGLASS_FLOWER.get().defaultBlockState(), 1).add(KoratioBlocks.PURPLE_SUGARGLASS_FLOWER.get().defaultBlockState(), 1).add(KoratioBlocks.MAGENTA_SUGARGLASS_FLOWER.get().defaultBlockState(), 1).add(KoratioBlocks.PINK_SUGARGLASS_FLOWER.get().defaultBlockState(), 1)), 64)));
