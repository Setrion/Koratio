...
public class KoratioFoods {
	...
	public static final FoodProperties CANDY_CANE = new FoodProperties.Builder().nutrition(3).saturationModifier(0.15F).alwaysEdible().build();
	public static final FoodProperties LOLLIPOP = new FoodProperties.Builder().nutrition(2).saturationModifier(0.1F).alwaysEdible().build();
	public static final FoodProperties BONBON = new FoodProperties.Builder().nutrition(1).saturationModifier(0.05F).alwaysEdible().build();
