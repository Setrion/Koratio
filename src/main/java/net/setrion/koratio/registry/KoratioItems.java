...
public class KoratioItems {
	...
	//SpawnEggs
	public static final DeferredItem<Item> MAGICAL_CAT_SPAWN_EGG = registerSpawnEgg("magical_cat_spawn_egg", properties -> new SpawnEggItem(KoratioEntityType.MAGICAL_CAT.get(), 0, 10682623, properties), new Item.Properties());
	public static final DeferredItem<Item> JUMSTEM_SPAWN_EGG = registerSpawnEgg("jumstem_spawn_egg", properties -> new SpawnEggItem(KoratioEntityType.JUMSTEM.get(), 13485757, 14136960, properties), new Item.Properties());
	public static final DeferredItem<Item> MOOSHROOM_SPAWN_EGG = registerSpawnEgg("mooshroom_spawn_egg", properties -> new SpawnEggItem(KoratioEntityType.MOOSHROOM.get(), 8851360, 12040119, properties), new Item.Properties());
	public static final DeferredItem<Item> SPIKY_PIG_SPAWN_EGG = registerSpawnEgg("spiky_pig_spawn_egg", properties -> new SpawnEggItem(KoratioEntityType.SPIKY_PIG.get(), 7923315, 12955180, properties), new Item.Properties());
	public static final DeferredItem<Item> DEMONIC_ZOMBIE_SPAWN_EGG = registerSpawnEgg("demonic_zombie_spawn_egg", properties -> new SpawnEggItem(KoratioEntityType.DEMONIC_ZOMBIE.get(), 44975, 16711776, properties), new Item.Properties());
	public static final DeferredItem<Item> DEMONIC_SKELETON_SPAWN_EGG = registerSpawnEgg("demonic_skeleton_spawn_egg", properties -> new SpawnEggItem(KoratioEntityType.DEMONIC_SKELETON.get(), 12698049, 16711776, properties), new Item.Properties());
	public static final DeferredItem<Item> DEMONIC_SOLDIER_SPAWN_EGG = registerSpawnEgg("demonic_soldier_spawn_egg", properties -> new SpawnEggItem(KoratioEntityType.DEMONIC_SOLDIER.get(), 5395026, 16711776, properties), new Item.Properties());
