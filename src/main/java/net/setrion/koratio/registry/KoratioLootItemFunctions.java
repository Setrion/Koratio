...
public class KoratioLootItemFunctions {
	...
	public static final RegistryObject<LootItemFunctionType> SET_SCROLL = LOOT_FUNCTION_TYPES.register("set_scroll", () -> new LootItemFunctionType(new SetScrollFunction.Serializer()));
