...
import net.setrion.koratio.world.level.levelgen.feature.HugeLollipopFeature;
...
public class KoratioFeatures {
	...
	public static final DeferredHolder<Feature<?>, HugeLollipopFeature> HUGE_LOLLIPOP = FEATURES.register("huge_lollipop", () -> new HugeLollipopFeature(NoneFeatureConfiguration.CODEC));
}