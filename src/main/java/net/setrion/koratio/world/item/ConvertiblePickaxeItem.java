...
public class ConvertiblePickaxeItem extends PickaxeItem implements Convertible {
    ...
    public ConvertiblePickaxeItem(Map<ResourceKey<DimensionType>, Item> convertibles, int convertTime, ToolMaterial material, float attackDamage, float attackSpeed, Properties properties) {
