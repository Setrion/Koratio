...
public class KoratioBlendedNoise extends BlendedNoise {

    public KoratioBlendedNoise(RandomSource random) {
        super(random, 0.9999999814507745, 0.9999999814507745, 180.0, 260.0, 0.0D);
    }
