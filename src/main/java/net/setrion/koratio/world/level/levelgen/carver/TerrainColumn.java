...
public class TerrainColumn implements Comparable<TerrainColumn> {
    ...
    instance.group(
            ...
            floatTreeCodec(Biome.CODEC).fieldOf("biome_layers").forGetter(o -> o.biomes),
	...
	public static <T> Codec<Float2ObjectSortedMap<T>> floatTreeCodec(Codec<T> elementCodec) {
        return Codec
                .compoundList(Codec.STRING.comapFlatMap(TerrainColumn::parseString2Float, f -> Float.toString(f)), elementCodec)
