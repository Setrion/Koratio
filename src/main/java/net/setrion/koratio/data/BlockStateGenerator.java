...
public class BlockStateGenerator extends BlockStateProvider {
	...
	protected void registerStatesAndModels() {		
		...
		simpleBlock(KoratioBlocks.WHITE_SUGARGLASS_FLOWER.get(), models().withExistingParent(Koratio.prefix("block/white_sugarglass_flower").getPath(), "koratio:block/template/sugarglass_flower").texture("base", Koratio.prefix("block/sugarglass_flower_base")).texture("overlay", Koratio.prefix("block/sugarglass_flower_overlay")).renderType("tripwire"));
		simpleBlock(KoratioBlocks.LIGHT_GRAY_SUGARGLASS_FLOWER.get(), models().withExistingParent(Koratio.prefix("block/light_gray_sugarglass_flower").getPath(), "koratio:block/template/sugarglass_flower").texture("base", Koratio.prefix("block/sugarglass_flower_base")).texture("overlay", Koratio.prefix("block/sugarglass_flower_overlay")).renderType("tripwire"));
		simpleBlock(KoratioBlocks.GRAY_SUGARGLASS_FLOWER.get(), models().withExistingParent(Koratio.prefix("block/gray_sugarglass_flower").getPath(), "koratio:block/template/sugarglass_flower").texture("base", Koratio.prefix("block/sugarglass_flower_base")).texture("overlay", Koratio.prefix("block/sugarglass_flower_overlay")).renderType("tripwire"));
		simpleBlock(KoratioBlocks.BLACK_SUGARGLASS_FLOWER.get(), models().withExistingParent(Koratio.prefix("block/black_sugarglass_flower").getPath(), "koratio:block/template/sugarglass_flower").texture("base", Koratio.prefix("block/sugarglass_flower_base")).texture("overlay", Koratio.prefix("block/sugarglass_flower_overlay")).renderType("tripwire"));
		simpleBlock(KoratioBlocks.BROWN_SUGARGLASS_FLOWER.get(), models().withExistingParent(Koratio.prefix("block/brown_sugarglass_flower").getPath(), "koratio:block/template/sugarglass_flower").texture("base", Koratio.prefix("block/sugarglass_flower_base")).texture("overlay", Koratio.prefix("block/sugarglass_flower_overlay")).renderType("tripwire"));
		simpleBlock(KoratioBlocks.RED_SUGARGLASS_FLOWER.get(), models().withExistingParent(Koratio.prefix("block/red_sugarglass_flower").getPath(), "koratio:block/template/sugarglass_flower").texture("base", Koratio.prefix("block/sugarglass_flower_base")).texture("overlay", Koratio.prefix("block/sugarglass_flower_overlay")).renderType("tripwire"));
		simpleBlock(KoratioBlocks.ORANGE_SUGARGLASS_FLOWER.get(), models().withExistingParent(Koratio.prefix("block/orange_sugarglass_flower").getPath(), "koratio:block/template/sugarglass_flower").texture("base", Koratio.prefix("block/sugarglass_flower_base")).texture("overlay", Koratio.prefix("block/sugarglass_flower_overlay")).renderType("tripwire"));
		simpleBlock(KoratioBlocks.YELLOW_SUGARGLASS_FLOWER.get(), models().withExistingParent(Koratio.prefix("block/yellow_sugarglass_flower").getPath(), "koratio:block/template/sugarglass_flower").texture("base", Koratio.prefix("block/sugarglass_flower_base")).texture("overlay", Koratio.prefix("block/sugarglass_flower_overlay")).renderType("tripwire"));
		simpleBlock(KoratioBlocks.LIME_SUGARGLASS_FLOWER.get(), models().withExistingParent(Koratio.prefix("block/lime_sugarglass_flower").getPath(), "koratio:block/template/sugarglass_flower").texture("base", Koratio.prefix("block/sugarglass_flower_base")).texture("overlay", Koratio.prefix("block/sugarglass_flower_overlay")).renderType("tripwire"));
		simpleBlock(KoratioBlocks.GREEN_SUGARGLASS_FLOWER.get(), models().withExistingParent(Koratio.prefix("block/green_sugarglass_flower").getPath(), "koratio:block/template/sugarglass_flower").texture("base", Koratio.prefix("block/sugarglass_flower_base")).texture("overlay", Koratio.prefix("block/sugarglass_flower_overlay")).renderType("tripwire"));
		simpleBlock(KoratioBlocks.CYAN_SUGARGLASS_FLOWER.get(), models().withExistingParent(Koratio.prefix("block/cyan_sugarglass_flower").getPath(), "koratio:block/template/sugarglass_flower").texture("base", Koratio.prefix("block/sugarglass_flower_base")).texture("overlay", Koratio.prefix("block/sugarglass_flower_overlay")).renderType("tripwire"));
		simpleBlock(KoratioBlocks.LIGHT_BLUE_SUGARGLASS_FLOWER.get(), models().withExistingParent(Koratio.prefix("block/light_blue_sugarglass_flower").getPath(), "koratio:block/template/sugarglass_flower").texture("base", Koratio.prefix("block/sugarglass_flower_base")).texture("overlay", Koratio.prefix("block/sugarglass_flower_overlay")).renderType("tripwire"));
		simpleBlock(KoratioBlocks.BLUE_SUGARGLASS_FLOWER.get(), models().withExistingParent(Koratio.prefix("block/blue_sugarglass_flower").getPath(), "koratio:block/template/sugarglass_flower").texture("base", Koratio.prefix("block/sugarglass_flower_base")).texture("overlay", Koratio.prefix("block/sugarglass_flower_overlay")).renderType("tripwire"));
		simpleBlock(KoratioBlocks.PURPLE_SUGARGLASS_FLOWER.get(), models().withExistingParent(Koratio.prefix("block/purple_sugarglass_flower").getPath(), "koratio:block/template/sugarglass_flower").texture("base", Koratio.prefix("block/sugarglass_flower_base")).texture("overlay", Koratio.prefix("block/sugarglass_flower_overlay")).renderType("tripwire"));
		simpleBlock(KoratioBlocks.MAGENTA_SUGARGLASS_FLOWER.get(), models().withExistingParent(Koratio.prefix("block/magenta_sugarglass_flower").getPath(), "koratio:block/template/sugarglass_flower").texture("base", Koratio.prefix("block/sugarglass_flower_base")).texture("overlay", Koratio.prefix("block/sugarglass_flower_overlay")).renderType("tripwire"));
		simpleBlock(KoratioBlocks.PINK_SUGARGLASS_FLOWER.get(), models().withExistingParent(Koratio.prefix("block/pink_sugarglass_flower").getPath(), "koratio:block/template/sugarglass_flower").texture("base", Koratio.prefix("block/sugarglass_flower_base")).texture("overlay", Koratio.prefix("block/sugarglass_flower_overlay")).renderType("tripwire"));
		...
		simpleBlock(KoratioBlocks.SKELETON_REMAINS.get(), models().withExistingParent(BuiltInRegistries.BLOCK.getKey(KoratioBlocks.SKELETON_REMAINS.get()).getPath(), Koratio.prefix("block/template/template_remains")));
		simpleBlock(KoratioBlocks.WITHER_SKELETON_REMAINS.get(), models().withExistingParent(BuiltInRegistries.BLOCK.getKey(KoratioBlocks.WITHER_SKELETON_REMAINS.get()).getPath(), Koratio.prefix("block/template/template_remains")));
		simpleBlock(KoratioBlocks.STRAY_REMAINS.get(), models().withExistingParent(BuiltInRegistries.BLOCK.getKey(KoratioBlocks.STRAY_REMAINS.get()).getPath(), Koratio.prefix("block/template/template_remains")));
		simpleBlock(KoratioBlocks.BOGGED_REMAINS.get(), models().withExistingParent(BuiltInRegistries.BLOCK.getKey(KoratioBlocks.BOGGED_REMAINS.get()).getPath(), Koratio.prefix("block/template/template_remains")));
		simpleBlock(KoratioBlocks.DEMONIC_SKELETON_REMAINS.get(), models().withExistingParent(BuiltInRegistries.BLOCK.getKey(KoratioBlocks.DEMONIC_SKELETON_REMAINS.get()).getPath(), Koratio.prefix("block/template/template_remains")));
		simpleBlock(KoratioBlocks.ZOMBIE_REMAINS.get(), models().withExistingParent(BuiltInRegistries.BLOCK.getKey(KoratioBlocks.ZOMBIE_REMAINS.get()).getPath(), Koratio.prefix("block/template/template_remains")));
		simpleBlock(KoratioBlocks.HUSK_REMAINS.get(), models().withExistingParent(BuiltInRegistries.BLOCK.getKey(KoratioBlocks.HUSK_REMAINS.get()).getPath(), Koratio.prefix("block/template/template_remains")));
		simpleBlock(KoratioBlocks.DROWNED_REMAINS.get(), models().withExistingParent(BuiltInRegistries.BLOCK.getKey(KoratioBlocks.DROWNED_REMAINS.get()).getPath(), Koratio.prefix("block/template/template_remains")));
		simpleBlock(KoratioBlocks.DEMONIC_ZOMBIE_REMAINS.get(), models().withExistingParent(BuiltInRegistries.BLOCK.getKey(KoratioBlocks.DEMONIC_ZOMBIE_REMAINS.get()).getPath(), Koratio.prefix("block/template/template_remains")));
		simpleBlock(KoratioBlocks.ZOMBIE_VILLAGER_REMAINS.get(), models().withExistingParent(BuiltInRegistries.BLOCK.getKey(KoratioBlocks.ZOMBIE_VILLAGER_REMAINS.get()).getPath(), Koratio.prefix("block/template/template_remains")));
		simpleBlock(KoratioBlocks.PHANTOM_REMAINS.get(), models().withExistingParent(BuiltInRegistries.BLOCK.getKey(KoratioBlocks.PHANTOM_REMAINS.get()).getPath(), Koratio.prefix("block/template/template_remains")));
		simpleBlock(KoratioBlocks.ZOMBIFIED_PIGLIN_REMAINS.get(), models().withExistingParent(BuiltInRegistries.BLOCK.getKey(KoratioBlocks.ZOMBIFIED_PIGLIN_REMAINS.get()).getPath(), Koratio.prefix("block/template/template_remains")));
