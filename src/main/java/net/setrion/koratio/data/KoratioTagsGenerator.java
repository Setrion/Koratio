...
public class KoratioTagsGenerator {
    ...
    public static class BlockTagGenerator extends IntrinsicHolderTagsProvider<Block> {
        ...
        protected void addTags(HolderLookup.Provider provider) {
            ...
            tag(KoratioTags.Blocks.LOGS).addTags(KoratioTags.Blocks.PANGO_LOGS, KoratioTags.Blocks.RUGONA_LOGS, KoratioTags.Blocks.VARESO_LOGS, KoratioTags.Blocks.CANDY_LOGS, KoratioTags.Blocks.ELVEN_LOGS);
            ...
            tag(BlockTags.SAPLINGS).add(KoratioBlocks.PANGO_SAPLING.get(), KoratioBlocks.RUGONA_SAPLING.get(), KoratioBlocks.VARESO_SAPLING.get(), KoratioBlocks.CANDY_SAPLING.get(), KoratioBlocks.ELVEN_SAPLING.get());
            tag(BlockTags.LEAVES).add(KoratioBlocks.PANGO_LEAVES.get(), KoratioBlocks.RUGONA_LEAVES.get(), KoratioBlocks.VARESO_LEAVES.get(), KoratioBlocks.COTTON_CANDY_LEAVES.get(), KoratioBlocks.ELVEN_LEAVES.get());
            tag(KoratioTags.Blocks.LEAF_PANES).add(KoratioBlocks.OAK_LEAF_PANE.get(), KoratioBlocks.SPRUCE_LEAF_PANE.get(), KoratioBlocks.BIRCH_LEAF_PANE.get(), KoratioBlocks.JUNGLE_LEAF_PANE.get(), KoratioBlocks.ACACIA_LEAF_PANE.get(), KoratioBlocks.DARK_OAK_LEAF_PANE.get(), KoratioBlocks.MANGROVE_LEAF_PANE.get(), KoratioBlocks.AZALEA_LEAF_PANE.get(), KoratioBlocks.FLOWERING_AZALEA_LEAF_PANE.get(), KoratioBlocks.CHERRY_LEAF_PANE.get(), KoratioBlocks.PANGO_LEAF_PANE.get(), KoratioBlocks.RUGONA_LEAF_PANE.get(), KoratioBlocks.VARESO_LEAF_PANE.get(), KoratioBlocks.COTTON_CANDY_LEAF_PANE.get(), KoratioBlocks.ELVEN_LEAF_PANE.get());
            tag(BlockTags.PLANKS).add(KoratioBlocks.PANGO_PLANKS.get(), KoratioBlocks.RUGONA_PLANKS.get(), KoratioBlocks.VARESO_PLANKS.get(), KoratioBlocks.CANDY_PLANKS.get(), KoratioBlocks.ELVEN_PLANKS.get(), KoratioBlocks.BLUE_ELVEN_PLANKS.get(), KoratioBlocks.CYAN_ELVEN_PLANKS.get(), KoratioBlocks.GREEN_ELVEN_PLANKS.get());
            tag(KoratioTags.Blocks.FENCES).add(KoratioBlocks.PANGO_FENCE.get(), KoratioBlocks.RUGONA_FENCE.get(), KoratioBlocks.VARESO_FENCE.get(), KoratioBlocks.CANDY_FENCE.get(), KoratioBlocks.ELVEN_FENCE.get(), KoratioBlocks.BLUE_ELVEN_FENCE.get(), KoratioBlocks.CYAN_ELVEN_FENCE.get(), KoratioBlocks.GREEN_ELVEN_FENCE.get());
            tag(KoratioTags.Blocks.FENCE_GATES).add(KoratioBlocks.PANGO_FENCE_GATE.get(), KoratioBlocks.RUGONA_FENCE_GATE.get(), KoratioBlocks.VARESO_FENCE_GATE.get(), KoratioBlocks.CANDY_FENCE_GATE.get(), KoratioBlocks.ELVEN_FENCE_GATE.get(), KoratioBlocks.BLUE_ELVEN_FENCE_GATE.get(), KoratioBlocks.CYAN_ELVEN_FENCE_GATE.get(), KoratioBlocks.GREEN_ELVEN_FENCE_GATE.get());
            tag(BlockTags.WOODEN_FENCES).add(KoratioBlocks.PANGO_FENCE.get(), KoratioBlocks.RUGONA_FENCE.get(), KoratioBlocks.VARESO_FENCE.get(), KoratioBlocks.CANDY_FENCE.get(), KoratioBlocks.ELVEN_FENCE.get(), KoratioBlocks.BLUE_ELVEN_FENCE.get(), KoratioBlocks.CYAN_ELVEN_FENCE.get(), KoratioBlocks.GREEN_ELVEN_FENCE.get());
            tag(BlockTags.FENCE_GATES).add(KoratioBlocks.PANGO_FENCE_GATE.get(), KoratioBlocks.RUGONA_FENCE_GATE.get(), KoratioBlocks.VARESO_FENCE_GATE.get(), KoratioBlocks.CANDY_FENCE_GATE.get(), KoratioBlocks.ELVEN_FENCE_GATE.get(), KoratioBlocks.BLUE_ELVEN_FENCE_GATE.get(), KoratioBlocks.CYAN_ELVEN_FENCE_GATE.get(), KoratioBlocks.GREEN_ELVEN_FENCE_GATE.get());
            tag(Tags.Blocks.FENCES_WOODEN).add(KoratioBlocks.PANGO_FENCE.get(), KoratioBlocks.RUGONA_FENCE.get(), KoratioBlocks.VARESO_FENCE.get(), KoratioBlocks.CANDY_FENCE.get(), KoratioBlocks.ELVEN_FENCE.get(), KoratioBlocks.BLUE_ELVEN_FENCE.get(), KoratioBlocks.CYAN_ELVEN_FENCE.get(), KoratioBlocks.GREEN_ELVEN_FENCE.get());
            tag(Tags.Blocks.FENCE_GATES_WOODEN).add(KoratioBlocks.PANGO_FENCE_GATE.get(), KoratioBlocks.RUGONA_FENCE_GATE.get(), KoratioBlocks.VARESO_FENCE_GATE.get(), KoratioBlocks.CANDY_FENCE_GATE.get(), KoratioBlocks.ELVEN_FENCE_GATE.get(), KoratioBlocks.BLUE_ELVEN_FENCE_GATE.get(), KoratioBlocks.CYAN_ELVEN_FENCE_GATE.get(), KoratioBlocks.GREEN_ELVEN_FENCE_GATE.get());
            tag(BlockTags.WOODEN_SLABS).add(KoratioBlocks.PANGO_SLAB.get(), KoratioBlocks.RUGONA_SLAB.get(), KoratioBlocks.VARESO_SLAB.get(), KoratioBlocks.CANDY_SLAB.get(), KoratioBlocks.ELVEN_SLAB.get(), KoratioBlocks.BLUE_ELVEN_SLAB.get(), KoratioBlocks.CYAN_ELVEN_SLAB.get(), KoratioBlocks.GREEN_ELVEN_SLAB.get());
            tag(BlockTags.WOODEN_STAIRS).add(KoratioBlocks.PANGO_STAIRS.get(), KoratioBlocks.RUGONA_STAIRS.get(), KoratioBlocks.VARESO_STAIRS.get(), KoratioBlocks.CANDY_STAIRS.get(), KoratioBlocks.ELVEN_STAIRS.get(), KoratioBlocks.BLUE_ELVEN_STAIRS.get(), KoratioBlocks.CYAN_ELVEN_STAIRS.get(), KoratioBlocks.GREEN_ELVEN_STAIRS.get());
            tag(BlockTags.WOODEN_BUTTONS).add(KoratioBlocks.PANGO_BUTTON.get(), KoratioBlocks.RUGONA_BUTTON.get(), KoratioBlocks.VARESO_BUTTON.get(), KoratioBlocks.CANDY_BUTTON.get(), KoratioBlocks.ELVEN_BUTTON.get(), KoratioBlocks.BLUE_ELVEN_BUTTON.get(), KoratioBlocks.CYAN_ELVEN_BUTTON.get(), KoratioBlocks.GREEN_ELVEN_BUTTON.get());
            tag(BlockTags.WOODEN_PRESSURE_PLATES).add(KoratioBlocks.PANGO_PRESSURE_PLATE.get(), KoratioBlocks.RUGONA_PRESSURE_PLATE.get(), KoratioBlocks.VARESO_PRESSURE_PLATE.get(), KoratioBlocks.CANDY_PRESSURE_PLATE.get(), KoratioBlocks.ELVEN_PRESSURE_PLATE.get(), KoratioBlocks.BLUE_ELVEN_PRESSURE_PLATE.get(), KoratioBlocks.CYAN_ELVEN_PRESSURE_PLATE.get(), KoratioBlocks.GREEN_ELVEN_PRESSURE_PLATE.get());
            tag(BlockTags.WOODEN_TRAPDOORS).add(KoratioBlocks.PANGO_TRAPDOOR.get(), KoratioBlocks.RUGONA_TRAPDOOR.get(), KoratioBlocks.VARESO_TRAPDOOR.get(), KoratioBlocks.CANDY_TRAPDOOR.get(), KoratioBlocks.ELVEN_TRAPDOOR.get(), KoratioBlocks.BLUE_ELVEN_TRAPDOOR.get(), KoratioBlocks.CYAN_ELVEN_TRAPDOOR.get(), KoratioBlocks.GREEN_ELVEN_TRAPDOOR.get());
            tag(BlockTags.WOODEN_DOORS).add(KoratioBlocks.PANGO_DOOR.get(), KoratioBlocks.RUGONA_DOOR.get(), KoratioBlocks.VARESO_DOOR.get(), KoratioBlocks.CANDY_DOOR.get(), KoratioBlocks.ELVEN_DOOR.get(), KoratioBlocks.BLUE_ELVEN_DOOR.get(), KoratioBlocks.CYAN_ELVEN_DOOR.get(), KoratioBlocks.GREEN_ELVEN_DOOR.get());
            tag(KoratioTags.Blocks.TALL_WOODEN_DOORS).add(KoratioBlocks.TALL_OAK_DOOR.get(), KoratioBlocks.TALL_SPRUCE_DOOR.get(), KoratioBlocks.TALL_BIRCH_DOOR.get(), KoratioBlocks.TALL_JUNGLE_DOOR.get(), KoratioBlocks.TALL_ACACIA_DOOR.get(), KoratioBlocks.TALL_DARK_OAK_DOOR.get(), KoratioBlocks.TALL_MANGROVE_DOOR.get(), KoratioBlocks.TALL_CHERRY_DOOR.get(), KoratioBlocks.TALL_BAMBOO_DOOR.get(), KoratioBlocks.TALL_CRIMSON_DOOR.get(), KoratioBlocks.TALL_WARPED_DOOR.get(), KoratioBlocks.TALL_PANGO_DOOR.get(), KoratioBlocks.TALL_RUGONA_DOOR.get(), KoratioBlocks.TALL_VARESO_DOOR.get(), KoratioBlocks.TALL_ELVEN_DOOR.get(), KoratioBlocks.TALL_BLUE_ELVEN_DOOR.get(), KoratioBlocks.TALL_CYAN_ELVEN_DOOR.get(), KoratioBlocks.TALL_GREEN_ELVEN_DOOR.get());
            ...
            tag(BlockTags.STANDING_SIGNS).add(KoratioBlocks.PANGO_SIGN.get(), KoratioBlocks.RUGONA_SIGN.get(), KoratioBlocks.VARESO_SIGN.get(), KoratioBlocks.CANDY_SIGN.get(), KoratioBlocks.ELVEN_SIGN.get(), KoratioBlocks.BLUE_ELVEN_SIGN.get(), KoratioBlocks.CYAN_ELVEN_SIGN.get(), KoratioBlocks.GREEN_ELVEN_SIGN.get());
            ...
            tag(BlockTags.WALL_SIGNS).add(KoratioBlocks.PANGO_WALL_SIGN.get(), KoratioBlocks.RUGONA_WALL_SIGN.get(), KoratioBlocks.VARESO_WALL_SIGN.get(), KoratioBlocks.CANDY_WALL_SIGN.get(), KoratioBlocks.ELVEN_WALL_SIGN.get());
            tag(BlockTags.WALL_HANGING_SIGNS).add(KoratioBlocks.PANGO_WALL_HANGING_SIGN.get(), KoratioBlocks.RUGONA_WALL_HANGING_SIGN.get(), KoratioBlocks.VARESO_WALL_HANGING_SIGN.get(), KoratioBlocks.CANDY_WALL_HANGING_SIGN.get(), KoratioBlocks.ELVEN_WALL_HANGING_SIGN.get());
            ...
            tag(BlockTags.ENCHANTMENT_POWER_PROVIDER).add(KoratioBlocks.PANGO_BOOKSHELF.get(), KoratioBlocks.RUGONA_BOOKSHELF.get(), KoratioBlocks.VARESO_BOOKSHELF.get(), KoratioBlocks.CANDY_BOOKSHELF.get(), KoratioBlocks.ELVEN_BOOKSHELF.get(), KoratioBlocks.BLUE_ELVEN_BOOKSHELF.get(), KoratioBlocks.CYAN_ELVEN_BOOKSHELF.get(), KoratioBlocks.GREEN_ELVEN_BOOKSHELF.get());
            ...
            ).addTag(KoratioTags.Blocks.TALL_WOODEN_DOORS);
