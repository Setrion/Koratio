...
public class RecipeGenerator extends RecipeProvider {
	...
	public static final ImmutableList<ItemLike> RUBY_SMELTABLES = ImmutableList.of(KoratioBlocks.RUBY_ORE.get(), KoratioBlocks.DEEPSLATE_RUBY_ORE.get());
	public static final ImmutableList<ItemLike> SAPPHIRE_SMELTABLES = ImmutableList.of(KoratioBlocks.SAPPHIRE_ORE.get(), KoratioBlocks.DEEPSLATE_SAPPHIRE_ORE.get());
	public static final ImmutableList<ItemLike> TOPAZ_SMELTABLES = ImmutableList.of(KoratioBlocks.TOPAZ_ORE.get(), KoratioBlocks.DEEPSLATE_TOPAZ_ORE.get());
	public static final ImmutableList<ItemLike> ONYX_SMELTABLES = ImmutableList.of(KoratioBlocks.ONYX_ORE.get(), KoratioBlocks.DEEPSLATE_ONYX_ORE.get());
	...
	protected void buildRecipes() {
		//ShapelessRecipes
		shapeless(RecipeCategory.MISC, KoratioItems.RAINBOW_GEM.get()).requires(Items.LAPIS_LAZULI).requires(Items.AMETHYST_SHARD).requires(Items.QUARTZ).requires(KoratioItems.TOPAZ.get()).requires(KoratioItems.SAPPHIRE.get()).requires(KoratioItems.RUBY.get()).requires(Items.EMERALD).requires(KoratioItems.ONYX.get()).requires(Items.DIAMOND).unlockedBy("has_netherite", has(Items.NETHERITE_INGOT)).save(output);
		decompress(KoratioItems.RAINBOW_GEM.get(), KoratioBlocks.RAINBOW_GEM_BLOCK.get()).save(output, Koratio.prefix("rainbow_gem_from_block").getPath());
		decompress(KoratioItems.RUBY.get(), KoratioBlocks.RUBY_BLOCK.get()).save(output, Koratio.prefix("ruby_from_block").getPath());
		decompress(KoratioItems.SAPPHIRE.get(), KoratioBlocks.SAPPHIRE_BLOCK.get()).save(output, Koratio.prefix("sapphire_from_block").getPath());
		decompress(KoratioItems.TOPAZ.get(), KoratioBlocks.TOPAZ_BLOCK.get()).save(output, Koratio.prefix("topaz_from_block").getPath());
		decompress(KoratioItems.ONYX.get(), KoratioBlocks.ONYX_BLOCK.get()).save(output, Koratio.prefix("onyx_from_block").getPath());

		shapeless(RecipeCategory.FOOD, KoratioItems.RED_SUGAR.get(), 8).requires(Items.SUGAR, 8).requires(Tags.Items.DYES_RED).group("red_sugar").unlockedBy("has_sugar", has(Items.SUGAR)).save(output);
		shapeless(RecipeCategory.FOOD, KoratioItems.BLUE_SUGAR.get(), 8).requires(Items.SUGAR, 8).requires(Tags.Items.DYES_BLUE).group("blue_sugar").unlockedBy("has_sugar", has(Items.SUGAR)).save(output);
		shapeless(RecipeCategory.FOOD, KoratioItems.YELLOW_SUGAR.get(), 8).requires(Items.SUGAR, 8).requires(Tags.Items.DYES_YELLOW).group("yellow_sugar").unlockedBy("has_sugar", has(Items.SUGAR)).save(output);
		shapeless(RecipeCategory.FOOD, KoratioItems.GREEN_SUGAR.get(), 8).requires(Items.SUGAR, 8).requires(Tags.Items.DYES_GREEN).group("green_sugar").unlockedBy("has_sugar", has(Items.SUGAR)).save(output);

		shapeless(RecipeCategory.MISC, KoratioItems.STICKY_WHITE_SUGAR_BUCKET.get()).requires(Items.BUCKET).requires(KoratioBlocks.STICKY_WHITE_SUGAR_BLOCK.get()).unlockedBy("has_sugar_block", has(KoratioBlocks.STICKY_WHITE_SUGAR_BLOCK.get())).save(output);
		shapeless(RecipeCategory.MISC, KoratioItems.STICKY_BLUE_SUGAR_BUCKET.get()).requires(Items.BUCKET).requires(KoratioBlocks.STICKY_BLUE_SUGAR_BLOCK.get()).unlockedBy("has_sugar_block", has(KoratioBlocks.STICKY_BLUE_SUGAR_BLOCK.get())).save(output);
		shapeless(RecipeCategory.MISC, KoratioItems.STICKY_GREEN_SUGAR_BUCKET.get()).requires(Items.BUCKET).requires(KoratioBlocks.STICKY_GREEN_SUGAR_BLOCK.get()).unlockedBy("has_sugar_block", has(KoratioBlocks.STICKY_GREEN_SUGAR_BLOCK.get())).save(output);
		shapeless(RecipeCategory.MISC, KoratioItems.STICKY_YELLOW_SUGAR_BUCKET.get()).requires(Items.BUCKET).requires(KoratioBlocks.STICKY_YELLOW_SUGAR_BLOCK.get()).unlockedBy("has_sugar_block", has(KoratioBlocks.STICKY_YELLOW_SUGAR_BLOCK.get())).save(output);
		shapeless(RecipeCategory.MISC, KoratioItems.STICKY_RED_SUGAR_BUCKET.get()).requires(Items.BUCKET).requires(KoratioBlocks.STICKY_RED_SUGAR_BLOCK.get()).unlockedBy("has_sugar_block", has(KoratioBlocks.STICKY_RED_SUGAR_BLOCK.get())).save(output);

		oneToOne(Items.COOKIE, KoratioBlocks.COOKIE_FLOWER.asItem()).save(output, Koratio.prefix("cookie_from_flower").getPath());
		oneToOne(Items.SUGAR, KoratioBlocks.WHITE_SUGARGLASS_FLOWER.asItem()).save(output, Koratio.prefix("sugar_from_flower").getPath());
		oneToOne(KoratioItems.BLUE_SUGAR.get(), KoratioBlocks.BLUE_SUGARGLASS_FLOWER.asItem()).save(output, Koratio.prefix("blue_sugar_from_flower").getPath());
		oneToOne(KoratioItems.GREEN_SUGAR.get(), KoratioBlocks.GREEN_SUGARGLASS_FLOWER.asItem()).save(output, Koratio.prefix("green_sugar_from_flower").getPath());
		oneToOne(KoratioItems.YELLOW_SUGAR.get(), KoratioBlocks.YELLOW_SUGARGLASS_FLOWER.asItem()).save(output, Koratio.prefix("yellow_sugar_from_flower").getPath());
		oneToOne(KoratioItems.RED_SUGAR.get(), KoratioBlocks.RED_SUGARGLASS_FLOWER.asItem()).save(output, Koratio.prefix("red_sugar_from_flower").getPath());
		
		decompress(Items.SUGAR, KoratioBlocks.WHITE_SUGAR_BLOCK.get()).save(output, Koratio.prefix("white_sugar_from_block").getPath());
		decompress(KoratioItems.RED_SUGAR.get(), KoratioBlocks.RED_SUGAR_BLOCK.get()).save(output, Koratio.prefix("red_sugar_from_block").getPath());
		decompress(KoratioItems.BLUE_SUGAR.get(), KoratioBlocks.BLUE_SUGAR_BLOCK.get()).save(output, Koratio.prefix("blue_sugar_from_block").getPath());
		decompress(KoratioItems.YELLOW_SUGAR.get(), KoratioBlocks.YELLOW_SUGAR_BLOCK.get()).save(output, Koratio.prefix("yellow_sugar_from_block").getPath());
		decompress(KoratioItems.GREEN_SUGAR.get(), KoratioBlocks.GREEN_SUGAR_BLOCK.get()).save(output, Koratio.prefix("green_sugar_from_block").getPath());
		
		button(KoratioBlocks.PANGO_BUTTON.get(), KoratioBlocks.PANGO_PLANKS).save(output);
		planksFromLogs(KoratioBlocks.PANGO_PLANKS.get(), KoratioTags.Items.PANGO_LOGS, 4);
		...
		planksFromLogs(KoratioBlocks.RUGONA_PLANKS.get(), KoratioTags.Items.RUGONA_LOGS, 4);
		...
		planksFromLogs(KoratioBlocks.VARESO_PLANKS.get(), KoratioTags.Items.VARESO_LOGS, 4);
		...
		planksFromLogs(KoratioBlocks.ELVEN_PLANKS.get(), KoratioTags.Items.ELVEN_LOGS, 4);
		...
		//ShapedRecipes
		shaped(RecipeCategory.BUILDING_BLOCKS, KoratioBlocks.WOODCUTTER.get()).pattern(" i ").pattern("sws").define('i', Tags.Items.INGOTS_IRON).define('s', Blocks.STONE).define('w', ItemTags.PLANKS).unlockedBy("has_iron_ingot", has(Tags.Items.INGOTS_IRON)).save(output);
		shaped(RecipeCategory.BUILDING_BLOCKS, KoratioBlocks.DECRYPTING_TABLE.get()).pattern("pb").pattern("ww").pattern("ww").define('p', Items.PAPER).define('b', Items.BOOK).define('w', ItemTags.PLANKS).unlockedBy("has_book", has(Items.BOOK)).save(output);
		shaped(RecipeCategory.BUILDING_BLOCKS, KoratioBlocks.CANDY_SHAPER.get()).pattern("ss").pattern("ww").pattern("ww").define('s', Blocks.STONE_SLAB).define('w', ItemTags.PLANKS).unlockedBy("has_planks", has(ItemTags.PLANKS)).save(output);

		shaped(RecipeCategory.TOOLS, KoratioItems.PIPING_BAG.get()).pattern(" sb").pattern("sgs").pattern("is ").define('s', Items.STRING).define('b', ItemTags.WOODEN_BUTTONS).define('g', Items.GLASS_BOTTLE).define('i', Items.BAMBOO).unlockedBy("has_glass_bottle", has(Items.GLASS_BOTTLE)).save(output);

		spatula(output, KoratioItems.WOODEN_ICING_SPATULA.get(), ItemTags.PLANKS);
		spatula(output, KoratioItems.STONE_ICING_SPATULA.get(), ItemTags.STONE_TOOL_MATERIALS);
		spatula(output, KoratioItems.GOLDEN_ICING_SPATULA.get(), Tags.Items.INGOTS_GOLD);
		spatula(output, KoratioItems.IRON_ICING_SPATULA.get(), Tags.Items.INGOTS_IRON);
		spatula(output, KoratioItems.DIAMOND_ICING_SPATULA.get(), Tags.Items.GEMS_DIAMOND);
		...
		woodFromLogs(KoratioBlocks.PANGO_WOOD.get(), KoratioBlocks.PANGO_LOG.get());
		woodFromLogs(KoratioBlocks.STRIPPED_PANGO_WOOD.get(), KoratioBlocks.STRIPPED_PANGO_LOG.get());
		...
		woodenBoat(KoratioItems.PANGO_BOAT.get(), KoratioBlocks.PANGO_PLANKS.get());
		chest(KoratioBlocks.PANGO_CHEST.get(), KoratioBlocks.PANGO_PLANKS).save(output);
		bookshelf(KoratioBlocks.PANGO_BOOKSHELF.get(), KoratioBlocks.PANGO_PLANKS);
		leafPane(KoratioBlocks.PANGO_LEAF_PANE.get(), KoratioBlocks.PANGO_LEAVES.get()).save(output);
		
		woodFromLogs(KoratioBlocks.RUGONA_WOOD.get(), KoratioBlocks.RUGONA_LOG.get());
		woodFromLogs(KoratioBlocks.STRIPPED_RUGONA_WOOD.get(), KoratioBlocks.STRIPPED_RUGONA_LOG.get());
		...
		woodenBoat(KoratioItems.RUGONA_BOAT.get(), KoratioBlocks.RUGONA_PLANKS.get());
		chest(KoratioBlocks.RUGONA_CHEST.get(), KoratioBlocks.RUGONA_PLANKS).save(output);
		bookshelf(KoratioBlocks.RUGONA_BOOKSHELF.get(), KoratioBlocks.RUGONA_PLANKS);
		leafPane(KoratioBlocks.RUGONA_LEAF_PANE.get(), KoratioBlocks.RUGONA_LEAVES.get()).save(output);

		woodFromLogs(KoratioBlocks.CANDY_WOOD.get(), KoratioBlocks.CANDY_LOG.get());
		woodFromLogs(KoratioBlocks.STRIPPED_CANDY_WOOD.get(), KoratioBlocks.STRIPPED_CANDY_LOG.get());
		...
		woodenBoat(KoratioItems.CANDY_BOAT.get(), KoratioBlocks.CANDY_PLANKS.get());
		chest(KoratioBlocks.CANDY_CHEST.get(), KoratioBlocks.CANDY_PLANKS).save(output);
		bookshelf(KoratioBlocks.CANDY_BOOKSHELF.get(), KoratioBlocks.CANDY_PLANKS);
		...
		woodFromLogs(KoratioBlocks.VARESO_WOOD.get(), KoratioBlocks.VARESO_LOG.get());
		woodFromLogs(KoratioBlocks.STRIPPED_VARESO_WOOD.get(), KoratioBlocks.STRIPPED_VARESO_LOG.get());
		...
		woodenBoat(KoratioItems.VARESO_BOAT.get(), KoratioBlocks.VARESO_PLANKS.get());
		chest(KoratioBlocks.VARESO_CHEST.get(), KoratioBlocks.VARESO_PLANKS).save(output);
		bookshelf(KoratioBlocks.VARESO_BOOKSHELF.get(), KoratioBlocks.VARESO_PLANKS);
		leafPane(KoratioBlocks.VARESO_LEAF_PANE.get(), KoratioBlocks.VARESO_LEAVES.get()).save(output);

		woodFromLogs(KoratioBlocks.ELVEN_WOOD.get(), KoratioBlocks.ELVEN_LOG.get());
		woodFromLogs(KoratioBlocks.STRIPPED_ELVEN_WOOD.get(), KoratioBlocks.STRIPPED_ELVEN_LOG.get());
		woodFromLogs(KoratioBlocks.STRIPPED_BLUE_ELVEN_WOOD.get(), KoratioBlocks.STRIPPED_BLUE_ELVEN_LOG.get());
		woodFromLogs(KoratioBlocks.STRIPPED_CYAN_ELVEN_WOOD.get(), KoratioBlocks.STRIPPED_CYAN_ELVEN_LOG.get());
		woodFromLogs(KoratioBlocks.STRIPPED_GREEN_ELVEN_WOOD.get(), KoratioBlocks.STRIPPED_GREEN_ELVEN_LOG.get());
		...
		woodenBoat(KoratioItems.ELVEN_BOAT.get(), KoratioBlocks.ELVEN_PLANKS.get());
		woodenBoat(KoratioItems.BLUE_ELVEN_BOAT.get(), KoratioBlocks.BLUE_ELVEN_PLANKS.get());
		woodenBoat(KoratioItems.CYAN_ELVEN_BOAT.get(), KoratioBlocks.CYAN_ELVEN_PLANKS.get());
		woodenBoat(KoratioItems.GREEN_ELVEN_BOAT.get(), KoratioBlocks.GREEN_ELVEN_PLANKS.get());
		chest(KoratioBlocks.ELVEN_CHEST.get(), KoratioBlocks.ELVEN_PLANKS).save(output);
		chest(KoratioBlocks.BLUE_ELVEN_CHEST.get(), KoratioBlocks.BLUE_ELVEN_PLANKS).save(output);
		chest(KoratioBlocks.CYAN_ELVEN_CHEST.get(), KoratioBlocks.CYAN_ELVEN_PLANKS).save(output);
		chest(KoratioBlocks.GREEN_ELVEN_CHEST.get(), KoratioBlocks.GREEN_ELVEN_PLANKS).save(output);
		bookshelf(KoratioBlocks.ELVEN_BOOKSHELF.get(), KoratioBlocks.ELVEN_PLANKS);
		bookshelf(KoratioBlocks.BLUE_ELVEN_BOOKSHELF.get(), KoratioBlocks.BLUE_ELVEN_PLANKS);
		bookshelf(KoratioBlocks.CYAN_ELVEN_BOOKSHELF.get(), KoratioBlocks.CYAN_ELVEN_PLANKS);
		bookshelf(KoratioBlocks.GREEN_ELVEN_BOOKSHELF.get(), KoratioBlocks.GREEN_ELVEN_PLANKS);
		leafPane(KoratioBlocks.ELVEN_LEAF_PANE.get(), KoratioBlocks.ELVEN_LEAVES.get()).save(output);

		shaped(RecipeCategory.FOOD, Items.CAKE).pattern("mmm").pattern("ses").pattern("www").define('m', Items.MILK_BUCKET).define('s', KoratioTags.Items.SUGAR).define('e', Tags.Items.EGGS).define('w', Items.WHEAT).unlockedBy("has_egg", has(Tags.Items.EGGS)).save(output);
		...
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(KoratioBlocks.RAW_GINGERBREAD_BLOCK), RecipeCategory.BUILDING_BLOCKS, KoratioBlocks.GINGERBREAD_BLOCK.get(), 0.5F, 200).unlockedBy("has_raw_gingerbread", has(KoratioBlocks.RAW_GINGERBREAD_BLOCK.get())).save(output, Koratio.prefix("gingerbread_block_from_smelting").getPath());
		...
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(KoratioBlocks.RAW_GINGERBREAD_STAIRS), RecipeCategory.BUILDING_BLOCKS, KoratioBlocks.GINGERBREAD_STAIRS.get(), 0.5F, 200).unlockedBy("has_raw_gingerbread", has(KoratioBlocks.RAW_GINGERBREAD_STAIRS.get())).save(output, Koratio.prefix("gingerbread_stairs_from_smelting").getPath());
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(KoratioBlocks.RAW_GINGERBREAD_BRICK_STAIRS), RecipeCategory.BUILDING_BLOCKS, KoratioBlocks.GINGERBREAD_BRICK_STAIRS.get(), 0.5F, 200).unlockedBy("has_raw_gingerbread", has(KoratioBlocks.RAW_GINGERBREAD_BRICK_STAIRS.get())).save(output, Koratio.prefix("gingerbread_brick_stairs_from_smelting").getPath());
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(KoratioBlocks.RAW_LARGE_GINGERBREAD_BRICK_STAIRS), RecipeCategory.BUILDING_BLOCKS, KoratioBlocks.LARGE_GINGERBREAD_BRICK_STAIRS.get(), 0.5F, 200).unlockedBy("has_raw_gingerbread", has(KoratioBlocks.RAW_LARGE_GINGERBREAD_BRICK_STAIRS.get())).save(output, Koratio.prefix("large_gingerbread_brick_stairs_from_smelting").getPath());
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(KoratioBlocks.RAW_GINGERBREAD_SLAB), RecipeCategory.BUILDING_BLOCKS, KoratioBlocks.GINGERBREAD_SLAB.get(), 0.5F, 200).unlockedBy("has_raw_gingerbread", has(KoratioBlocks.RAW_GINGERBREAD_SLAB.get())).save(output, Koratio.prefix("gingerbread_slab_from_smelting").getPath());
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(KoratioBlocks.RAW_GINGERBREAD_BRICK_SLAB), RecipeCategory.BUILDING_BLOCKS, KoratioBlocks.GINGERBREAD_BRICK_SLAB.get(), 0.5F, 200).unlockedBy("has_raw_gingerbread", has(KoratioBlocks.RAW_GINGERBREAD_BRICK_SLAB.get())).save(output, Koratio.prefix("gingerbread_brick_slab_from_smelting").getPath());
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(KoratioBlocks.RAW_LARGE_GINGERBREAD_BRICK_SLAB), RecipeCategory.BUILDING_BLOCKS, KoratioBlocks.LARGE_GINGERBREAD_BRICK_SLAB.get(), 0.5F, 200).unlockedBy("has_raw_gingerbread", has(KoratioBlocks.RAW_LARGE_GINGERBREAD_BRICK_SLAB.get())).save(output, Koratio.prefix("large_gingerbread_brick_slab_from_smelting").getPath());
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(KoratioBlocks.RAW_GINGERBREAD_WALL), RecipeCategory.BUILDING_BLOCKS, KoratioBlocks.GINGERBREAD_WALL.get(), 0.5F, 200).unlockedBy("has_raw_gingerbread", has(KoratioBlocks.RAW_GINGERBREAD_WALL.get())).save(output, Koratio.prefix("gingerbread_wall_from_smelting").getPath());
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(KoratioBlocks.RAW_GINGERBREAD_BRICK_WALL), RecipeCategory.BUILDING_BLOCKS, KoratioBlocks.GINGERBREAD_BRICK_WALL.get(), 0.5F, 200).unlockedBy("has_raw_gingerbread", has(KoratioBlocks.RAW_GINGERBREAD_BRICK_WALL.get())).save(output, Koratio.prefix("gingerbread_brick_wall_from_smelting").getPath());
		...
		//SmokingRecipes
		SimpleCookingRecipeBuilder.smoking(Ingredient.of(KoratioItems.SPIKED_PORKCHOP.get()), RecipeCategory.FOOD, KoratioItems.COOKED_SPIKED_PORKCHOP.get(), 0.35F, 100).unlockedBy("has_spiked_porkchop", has(KoratioItems.SPIKED_PORKCHOP.get())).save(output, Koratio.prefix("cooked_spiked_porkchop_from_smoking").getPath());
		SimpleCookingRecipeBuilder.smoking(Ingredient.of(KoratioItems.FLUFFER.get()), RecipeCategory.FOOD, KoratioItems.COOKED_FLUFFER.get(), 0.35F, 100).unlockedBy("has_fluffer", has(KoratioItems.FLUFFER.get())).save(output, Koratio.prefix("cooked_fluffer_from_smoking").getPath());
		...
		//CampfireRecipes
		SimpleCookingRecipeBuilder.campfireCooking(Ingredient.of(KoratioItems.RAW_PANGO.get()), RecipeCategory.FOOD, KoratioItems.CRACKED_PANGO.get(), 0.35F, 600).unlockedBy("has_raw_pango", has(KoratioItems.RAW_PANGO.get())).save(output, Koratio.prefix("cracked_pango_from_campfire_cooking").getPath());
		SimpleCookingRecipeBuilder.campfireCooking(Ingredient.of(KoratioItems.SPIKED_PORKCHOP.get()), RecipeCategory.FOOD, KoratioItems.COOKED_SPIKED_PORKCHOP.get(), 0.35F, 600).unlockedBy("has_spiked_porkchop", has(KoratioItems.SPIKED_PORKCHOP.get())).save(output, Koratio.prefix("cooked_spiked_porkchop_from_campfire_cooking").getPath());
		SimpleCookingRecipeBuilder.campfireCooking(Ingredient.of(KoratioItems.FLUFFER.get()), RecipeCategory.FOOD, KoratioItems.COOKED_FLUFFER.get(), 0.35F, 600).unlockedBy("has_fluffer", has(KoratioItems.FLUFFER.get())).save(output, Koratio.prefix("cooked_fluffer_from_campfire_cooking").getPath());

		//SmithingRecipes
		netheriteSmithing(KoratioItems.DIAMOND_ICING_SPATULA.get(), RecipeCategory.TOOLS, KoratioItems.NETHERITE_ICING_SPATULA.get());
	...
	protected ShapedRecipeBuilder door(Block output, DeferredBlock<? extends Block> input) {
		return shaped(RecipeCategory.REDSTONE, output, 3).pattern("xx").pattern("xx").pattern("xx").define('x', input.get()).group("wooden_door").unlockedBy("has_"+input.getId().getPath(), has(input.get()));
	}

	protected ShapedRecipeBuilder tallDoor(Block output, Block input, Block door, String group) {
		return shaped(RecipeCategory.REDSTONE, output, 2).pattern("x").pattern("#").pattern("x").define('x', input).define('#', door).group(group).unlockedBy("has_door", has(door));
	}
	
	protected ShapedRecipeBuilder fence(Block output, DeferredBlock<? extends Block> input) {
		return shaped(RecipeCategory.DECORATIONS, output, 3).pattern("x#x").pattern("x#x").define('x', input.get()).define('#', Items.STICK).group("wooden_fence").unlockedBy("has_"+input.getId().getPath(), has(input.get()));
	}
	
	protected ShapedRecipeBuilder fenceGate(Block output, DeferredBlock<? extends Block> input) {
		return shaped(RecipeCategory.DECORATIONS, output).pattern("x#x").pattern("x#x").define('#', input.get()).define('x', Items.STICK).group("wooden_fence_gate").unlockedBy("has_"+input.getId().getPath(), has(input.get()));
	}
	
	protected ShapedRecipeBuilder pressurePlate(Block output, DeferredBlock<? extends Block> input) {
		return shaped(RecipeCategory.REDSTONE, output).pattern("xx").define('x', input.get()).group("wooden_pressure_plate").unlockedBy("has_"+input.getId().getPath(), has(input.get()));
	}
	
	protected ShapelessRecipeBuilder button(Block output, DeferredBlock<? extends Block> input) {
		return shapeless(RecipeCategory.REDSTONE, output).requires(input.get()).unlockedBy("has_"+input.getId().getPath(), has(input.get()));
	}
	
	protected ShapedRecipeBuilder slab(Block output, DeferredBlock<? extends Block> input) {
		return shaped(RecipeCategory.BUILDING_BLOCKS, output, 6).pattern("xxx").define('x', input.get()).group("wooden_slab").unlockedBy("has_"+input.getId().getPath(), has(input.get()));
	}
	
	protected ShapedRecipeBuilder woodenSlab(Block output, DeferredBlock<? extends Block> input) {
		return slab(output, input).group("wooden_slab");
	}
	
	protected ShapedRecipeBuilder stairs(Block output, DeferredBlock<? extends Block> input) {
		return shaped(RecipeCategory.BUILDING_BLOCKS, output, 4).pattern("x  ").pattern("xx ").pattern("xxx").define('x', input.get()).unlockedBy("has_"+input.getId().getPath(), has(input.get()));
	}
	
	protected ShapedRecipeBuilder woodenStairs(Block output, DeferredBlock<? extends Block> input) {
		return stairs(output, input).group("wooden_stairs");
	}
	
	protected ShapedRecipeBuilder trapdoor(Block output, DeferredBlock<? extends Block> input) {
		return shaped(RecipeCategory.REDSTONE, output, 2).pattern("xxx").pattern("xxx").define('x', input.get()).group("wooden_trapdoor").unlockedBy("has_"+input.getId().getPath(), has(input.get()));
	}

	protected ShapedRecipeBuilder leafPane(Block output, Block input) {
		return shaped(RecipeCategory.DECORATIONS, output, 16).pattern("xxx").pattern("xxx").define('x', input).group("leaf_pane").unlockedBy("has_leaves", has(input));
	}
	
	protected ShapedRecipeBuilder wall(Block output, DeferredBlock<? extends Block> input) {
		return shaped(RecipeCategory.BUILDING_BLOCKS, output, 2).pattern("xxx").pattern("xxx").define('x', input.get()).unlockedBy("has_"+input.getId().getPath(), has(input.get()));
	}
	
	protected ShapedRecipeBuilder sign(Block output, DeferredBlock<? extends Block> input) {
		return shaped(RecipeCategory.DECORATIONS, output, 3).pattern("xxx").pattern("xxx").pattern(" # ").define('x', input.get()).define('#', Items.STICK).group("wooden_sign").unlockedBy("has_"+input.getId().getPath(), has(input.get()));
	}
	
	protected ShapedRecipeBuilder hangingSign(Block output, DeferredBlock<? extends Block> input) {
		return shaped(RecipeCategory.DECORATIONS, output, 6).pattern("# #").pattern("xxx").pattern("xxx").define('x', input.get()).define('#', Items.CHAIN).group("wooden_hanging_sign").unlockedBy("has_"+input.getId().getPath(), has(input.get()));
	}
	
	protected ShapedRecipeBuilder chest(ItemLike output, DeferredBlock<? extends Block> input) {
		return shaped(RecipeCategory.DECORATIONS, output, 2).pattern("###").pattern("#x#").pattern("###").define('#', input.get()).define('x', Tags.Items.CHESTS_WOODEN).group("chests").unlockedBy("has_planks", has(input.get()));
	}

	protected void bookshelf(ItemLike result, DeferredBlock<? extends Block> input) {
		shaped(RecipeCategory.BUILDING_BLOCKS, result).pattern("###").pattern("xxx").pattern("###").define('#', input.get()).define('x', Items.BOOK).group("bookshelfs").unlockedBy("has_books", has(Items.BOOK));
	}
	
	protected void chestBoat(RecipeOutput output, ItemLike result, ItemLike input) {
		shapeless(RecipeCategory.TRANSPORTATION, result).requires(Tags.Items.CHESTS_WOODEN).requires(input).group("chest_boat").unlockedBy("has_boat", has(ItemTags.BOATS)).save(output);
	}
	
	protected void twoByTwo(RecipeOutput output, ItemLike result, ItemLike input) {
		shaped(RecipeCategory.BUILDING_BLOCKS, result, 4).pattern("##").pattern("##").define('#', input).unlockedBy("has_"+BuiltInRegistries.ITEM.getKey(input.asItem()).getPath(), has(MinMaxBounds.Ints.atLeast(4), input)).save(output);
	}
	
	protected ShapelessRecipeBuilder oneToOne(Item output, Item input) {
		return shapeless(RecipeCategory.MISC, output).requires(input).unlockedBy("has_"+BuiltInRegistries.ITEM.getKey(input).getPath(), has(input));
	}
	
	protected ShapedRecipeBuilder compress(ItemLike output, ItemLike input) {
		return shaped(RecipeCategory.BUILDING_BLOCKS, output).pattern("xxx").pattern("xxx").pattern("xxx").define('x', input).unlockedBy("has_"+BuiltInRegistries.ITEM.getKey(input.asItem()).getPath(), has(MinMaxBounds.Ints.atLeast(9), input));
	}
	
	protected ShapelessRecipeBuilder decompress(Item output, ItemLike input) {
		return shapeless(RecipeCategory.MISC, output, 9).requires(input).unlockedBy("has_"+BuiltInRegistries.ITEM.getKey(input.asItem()).getPath(), has(input));
	}
	
	protected void sword(RecipeOutput output, Item result, Ingredient ingredient) {
		shaped(RecipeCategory.COMBAT, result).define('#', Items.STICK).define('X', ingredient).pattern("X").pattern("X").pattern("#").unlockedBy("has_stick", has(Items.STICK)).save(output);
	}
	
	protected void pickaxe(RecipeOutput output, Item result, Ingredient ingredient) {
		shaped(RecipeCategory.TOOLS, result).define('#', Items.STICK).define('X', ingredient).pattern("XXX").pattern(" # ").pattern(" # ").unlockedBy("has_stick", has(Items.STICK)).save(output);
	}
	
	protected void axe(RecipeOutput output, Item result, Ingredient ingredient) {
		shaped(RecipeCategory.TOOLS, result).define('#', Items.STICK).define('X', ingredient).pattern("XX").pattern("X#").pattern(" #").unlockedBy("has_stick", has(Items.STICK)).save(output);
	}
	
	protected void shovel(RecipeOutput output, Item result, Ingredient ingredient) {
		shaped(RecipeCategory.TOOLS, result).define('#', Items.STICK).define('X', ingredient).pattern("X").pattern("#").pattern("#").unlockedBy("has_stick", has(Items.STICK)).save(output);
	}
	
	protected void hoe(RecipeOutput output, Item result, Ingredient ingredient) {
		shaped(RecipeCategory.TOOLS, result).define('#', Items.STICK).define('X', ingredient).pattern("XX").pattern(" #").pattern(" #").unlockedBy("has_stick", has(Items.STICK)).save(output);
	}

	protected void spatula(RecipeOutput output, Item result, TagKey<Item> item) {
		shaped(RecipeCategory.TOOLS, result).define('#', Items.STICK).define('X', item).pattern(" X").pattern("X ").pattern("# ").unlockedBy("has_stick", has(Items.STICK)).save(output);
	}
	
	protected void helmet(RecipeOutput output, Item result, Item ingredient) {
		shaped(RecipeCategory.COMBAT, result).define('X', ingredient).pattern("XXX").pattern("X X").unlockedBy("has_"+BuiltInRegistries.ITEM.getKey(ingredient).getPath(), has(ingredient)).save(output);
	}
	
	protected void chestplate(RecipeOutput output, Item result, Item ingredient) {
		shaped(RecipeCategory.COMBAT, result).define('X', ingredient).pattern("X X").pattern("XXX").pattern("XXX").unlockedBy("has_"+BuiltInRegistries.ITEM.getKey(ingredient).getPath(), has(ingredient)).save(output);
	}
	
	protected void leggings(RecipeOutput output, Item result, Item ingredient) {
		shaped(RecipeCategory.COMBAT, result).define('X', ingredient).pattern("XXX").pattern("X X").pattern("X X").unlockedBy("has_"+BuiltInRegistries.ITEM.getKey(ingredient).getPath(), has(ingredient)).save(output);
	}
	
	protected void boots(RecipeOutput output, Item result, Item ingredient) {
		shaped(RecipeCategory.COMBAT, result).define('X', ingredient).pattern("X X").pattern("X X").unlockedBy("has_"+BuiltInRegistries.ITEM.getKey(ingredient).getPath(), has(ingredient)).save(output);
	}
	
	protected void oreSmelting(RecipeOutput output, List<ItemLike> input, RecipeCategory category, ItemLike result, float xp, int time, String group) {
		oreCooking(output, RecipeSerializer.SMELTING_RECIPE, SmeltingRecipe::new, input, category, result, xp, time, group, "_from_smelting");
	}

	protected void oreBlasting(RecipeOutput output, List<ItemLike> input, RecipeCategory category, ItemLike result, float xp, int time, String group) {
		oreCooking(output, RecipeSerializer.BLASTING_RECIPE, BlastingRecipe::new, input, category, result, xp, time, group, "_from_blasting");
	}

	protected <T extends AbstractCookingRecipe> void oreCooking(RecipeOutput output, RecipeSerializer<T> serializer, AbstractCookingRecipe.Factory<T> factory, List<ItemLike> input, RecipeCategory category, ItemLike result, float xp, int time, String group, String extra) {
		for(ItemLike itemlike : input) {
			SimpleCookingRecipeBuilder.generic(Ingredient.of(itemlike), category, result, xp, time, serializer, factory).group(group).unlockedBy(getHasName(itemlike), has(itemlike)).save(output, Koratio.prefix(getItemName(result) + extra + "_" + getItemName(itemlike)).getPath());
		}
	}
	
	protected void stonecutterResultFromBase(RecipeOutput output, RecipeCategory category, ItemLike result, ItemLike ingredient, int amount) {
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(ingredient), category, result, amount).unlockedBy("has_"+getItemName(ingredient), has(ingredient)).save(output, Koratio.prefix(getItemName(result)+"_from_"+getItemName(ingredient) + "_stonecutting").getPath());
	}

	protected void woodcutterResultFromBase(RecipeOutput output, RecipeCategory category, ItemLike result, ItemLike ingredient, int amount) {
		woodcutting(Ingredient.of(ingredient), category, result, amount).unlockedBy("has_"+getItemName(ingredient), has(ingredient)).save(output, Koratio.prefix(getItemName(result)+"_from_"+getItemName(ingredient) + "_woodcutting").getPath());
	}
