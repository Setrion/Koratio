...
@OnlyIn(Dist.CLIENT)
public class KoratioBatModel extends HierarchicalModel<AbstractHostileBat> {
	...
	public KoratioBatModel(ModelPart part) {
		this.root = part;
	...
	public void setupAnim(AbstractHostileBat p_102200_, float p_102201_, float p_102202_, float p_102203_, float p_102204_, float p_102205_) {
