...
public class GoldenParrotModel extends HierarchicalModel<GoldenParrot> {
	...
	public GoldenParrotModel(ModelPart part) {
		this.root = part;
	...
	public void setupAnim(GoldenParrot p_103217_, float p_103218_, float p_103219_, float p_103220_, float p_103221_, float p_103222_) {
		this.setupAnim(getState(p_103217_), p_103217_.tickCount, p_103218_, p_103219_, p_103220_, p_103221_, p_103222_);
	}

	public void prepareMobModel(GoldenParrot p_103212_, float p_103213_, float p_103214_, float p_103215_) {
	...
	public void renderOnShoulder(PoseStack p_103224_, VertexConsumer p_103225_, int p_103226_, int p_103227_, float p_103228_, float p_103229_, float p_103230_, float p_103231_, int p_103232_) {
		this.prepare(GoldenParrotModel.State.ON_SHOULDER);
		this.setupAnim(GoldenParrotModel.State.ON_SHOULDER, p_103232_, p_103228_, p_103229_, 0.0F, p_103230_, p_103231_);
		this.root.render(p_103224_, p_103225_, p_103226_, p_103227_);
	}

	private void setupAnim(GoldenParrotModel.State state, int p_103243_, float p_103244_, float p_103245_, float p_103246_, float p_103247_, float p_103248_) {
	...
	private void prepare(GoldenParrotModel.State state) {
	...
	private static GoldenParrotModel.State getState(GoldenParrot parrot) {
		if (parrot.isPartyParrot()) {
			return GoldenParrotModel.State.PARTY;
		} else if (parrot.isInSittingPose()) {
			return GoldenParrotModel.State.SITTING;
		} else {
			return parrot.isFlying() ? GoldenParrotModel.State.FLYING : GoldenParrotModel.State.STANDING;
		}
	}
