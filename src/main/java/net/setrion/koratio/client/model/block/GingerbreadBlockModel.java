...
public class GingerbreadBlockModel extends BakedModelWrapper<BakedModel> {
    ...
    private CacheKey cacheModel(ModelData modelData) {
        ...
        boolData[0] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_NORTH_LEFT));
        boolData[1] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_NORTH_RIGHT));
        boolData[2] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_NORTH_TOP));
        boolData[3] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_NORTH_BOTTOM));
        boolData[4] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_NORTH_MIDDLE));
        boolData[5] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_EAST_LEFT));
        boolData[6] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_EAST_RIGHT));
        boolData[7] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_EAST_TOP));
        boolData[8] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_EAST_BOTTOM));
        boolData[9] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_EAST_MIDDLE));
        boolData[10] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_SOUTH_LEFT));
        boolData[11] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_SOUTH_RIGHT));
        boolData[12] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_SOUTH_TOP));
        boolData[13] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_SOUTH_BOTTOM));
        boolData[14] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_SOUTH_MIDDLE));
        boolData[15] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_WEST_LEFT));
        boolData[16] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_WEST_RIGHT));
        boolData[17] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_WEST_TOP));
        boolData[18] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_WEST_BOTTOM));
        boolData[19] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_WEST_MIDDLE));
        boolData[20] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_TOP_LEFT));
        boolData[21] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_TOP_RIGHT));
        boolData[22] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_TOP_TOP));
        boolData[23] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_TOP_BOTTOM));
        boolData[24] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_TOP_MIDDLE));
        boolData[25] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_BOTTOM_LEFT));
        boolData[26] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_BOTTOM_RIGHT));
        boolData[27] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_BOTTOM_TOP));
        boolData[28] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_BOTTOM_BOTTOM));
        boolData[29] = Boolean.TRUE.equals(modelData.get(GingerbreadBlockEntity.GLAZED_BOTTOM_MIDDLE));
