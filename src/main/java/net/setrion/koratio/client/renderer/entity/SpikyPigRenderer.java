...
public class SpikyPigRenderer extends MobRenderer<SpikyPig, SpikyPigModel<SpikyPig>>{
	...
	public static final ResourceLocation TEXTURES = new ResourceLocation(Koratio.MOD_ID + ":textures/entity/spiky_pig.png");
	...
	public SpikyPigRenderer(Context context) {
		...
		this.addLayer(new SaddleLayer<>(this, new SpikyPigModel<>(context.bakeLayer(ModelLayers.PIG_SADDLE)), new ResourceLocation("textures/entity/pig/pig_saddle.png")));
	}
