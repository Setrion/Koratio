...
@OnlyIn(Dist.CLIENT)
public class ThunderBatRenderer extends MobRenderer<AbstractHostileBat, KoratioBatModel> {
	private static final ResourceLocation THUNDER_BAT_LOCATION = new ResourceLocation(Koratio.MOD_ID, "textures/entity/thunder_bat.png");

	public ThunderBatRenderer(EntityRendererProvider.Context context) {
		super(context, new KoratioBatModel(context.bakeLayer(ModelLayers.THUNDER_BAT)), 0.25F);
	}

	public ResourceLocation getTextureLocation(AbstractHostileBat bat) {
		return THUNDER_BAT_LOCATION;
	}
