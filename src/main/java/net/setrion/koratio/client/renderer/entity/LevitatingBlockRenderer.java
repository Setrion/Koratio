...
@OnlyIn(Dist.CLIENT)
public class LevitatingBlockRenderer extends EntityRenderer<LevitatingBlockEntity> {
    ...
    public void render(LevitatingBlockEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
     ...
     */
    public ResourceLocation getTextureLocation(LevitatingBlockEntity entity) {
