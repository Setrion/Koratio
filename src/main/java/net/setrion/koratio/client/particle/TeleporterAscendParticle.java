...
public class TeleporterAscendParticle extends TextureSheetParticle {
    protected TeleporterAscendParticle(ClientLevel pLevel, double pX, double pY, double pZ) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            TeleporterAscendParticle teleporterAscendParticle = new TeleporterAscendParticle(pLevel, pX, pY, pZ);
            teleporterAscendParticle.pickSprite(this.sprite);
            return teleporterAscendParticle;
        }
    }
}